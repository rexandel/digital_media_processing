        ...
        for x in range(width):
            ...
            for k in range(kernel_size):
                for l in range(kernel_size):
                    val += img_padded[y_padded + k - padding_size, x_padded + l - padding_size] * kernel[k, l]
...
def main():
    ...
    img = cv2.imread(r'C:\Users\rexandel\Documents\GitHub\digital_media_processing\filtering_and_blurring_methods\images\cat.png')
    ...
    img_blur = gaussian_blur(img_gray, kernel_size, std_deviation)
